...
export default function WorkingWithArrays() {
  ...
  <h3>Removing from an Array</h3>
    ...
    <FormControl defaultValue={todo.id} className="w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })}/>
    <FormControl as="textarea" defaultValue={todo.description} className="w-50 float-start"
    ...
    <div>
     <a className="btn btn-primary float-end"
      ...
      <label htmlFor="wd-todo-completed" className="ms-2 mt-2 mb-2">Completed</label>
      </div>
      <hr />
