...
tag to tell browsers to render the gaps.
  ...
  <ol id="wd-your-favorite-recipe">
    ...
    <li>add spices and garlic </li>
    <li> add tomato paste and sriracha/chili paste</li>
    <li>add tomatos, cook until juicy</li>
    <li>add cooked pasta and a few tablespoons of pasta water </li>
    <li>blend </li>
    <li>add heavy cream and parmesean cheese </li>
    <li>8. serve with more cheese and fresh basil </li>
  </ol>
      </div>
...
<textarea id="wd-textarea" cols={30} rows={10}> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
